...
<button class="w3-bar-item w3-button" onclick="openCity('all_by_realization_date')">Wszystkie zamówienia</button>
  <button class="w3-bar-item w3-button" onclick="openCity('current_by_realization_date')">Wszystkie aktualne zamówienia</button>
  <button class="w3-bar-item w3-button" onclick="openCity('current_by_product_name')">Wszystkie aktualnie zamówione produkty</button>
    ...
    if (oci_execute($stm)) { 
        ...
        while (($row = oci_fetch_row($stm)) != false)
        {
            echo "<tr>
                ...
                <td>{$row[7]}</td>
                <td width = 500px>
                <a href=\"../orders_action/change_order_status_form.php?order_id={$row[0]}\" class=menuButton2>Zmień status</a></td>
            </tr>";
        }
        echo "</table>";
    ...
    if (oci_execute($stm)) { 
        ...
        while (($row = oci_fetch_row($stm)) != false)
        {
            echo "<tr>
                ...
                <td width = 500px><a href=\"../orders_action/change_order_status_form.php?order_id={$row[0]}\" class=menuButton2>Zmień status</a></td>
            </tr>";
        }
        echo "</table>";
